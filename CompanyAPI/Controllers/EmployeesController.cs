            ...
            return await _context.Employees
                ...
                {   
                    ...
                    ImageSrc = String.Format("{0}://{1}{2}/Images/{3}",
                        Request.Scheme, Request.Host, Request.PathBase, emp.ImageName)
                })
                .ToListAsync();
            ///
            /// Request.Scheme - http, https, ftp, ftps ...
            /// Request.Host - localhost:<port>
            /// Request.PathBase - <ContentRootPath>
            /// emp.ImageName - ім'я файлу зображення
            ///
        }
